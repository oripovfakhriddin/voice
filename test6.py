...
def extract_features(audio_file):
    try:
        ...
        messagebox.showerror("Xato", f"Ovoz faylidan xususiyatlarni chiqarishda xato: {e}")
        return None
...
def test_gmm():
    ...
    if test_features is None:
        return  # Exit if feature extraction failed
...
def record_voice():
    ...
    if user_name:
        ...
        if user_features is not None:
            ...
            messagebox.showerror("Xato", f"{user_name} uchun xususiyatlarni chiqarishda xato yuz berdi.")
    else:

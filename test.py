...
# Standard text for reading in three languages (Uzbek by default)
texts = {
...
tk.Button(button_frame, text="O`qitish", command=train_model, font=('Arial', 14)).pack(side=tk.LEFT, padx=10)
tk.Button(button_frame, text="Ovoz sinash", command=test_model, font=('Arial', 14)).pack(side=tk.LEFT, padx=10)
